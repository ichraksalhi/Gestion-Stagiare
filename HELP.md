...
* The following dependencies are not known to work with Spring Native: 'Spring Session, Vaadin, Spring Configuration
  Processor, Rest Repositories, Spring HATEOAS, Jersey, Rest Repositories HAL Explorer, Spring Web Services, Spring Boot
